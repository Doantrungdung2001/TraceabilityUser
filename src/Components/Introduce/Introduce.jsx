...
const data = [
    {
        ...
        detail: "Exercitation in fugiat est ut ad cupidate it in cupidatat occaecat ut occaecat"
    },
    {
        icon: <MdCancel/>,
        ...
        <div className="paddings innerWidth flexCenter v-container">
            ...
            <div className="flexColStart v-right">
                ...
                <span className='secondaryText'>
                    We always ready to help by providding the best services for you.<br />
